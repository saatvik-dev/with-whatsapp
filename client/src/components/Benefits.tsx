      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="w-full lg:w-1/2 order-2 lg:order-1">
            <span className="text-amber-600 font-medium">LIFETIME PERFORMANCE</span>
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-amber-500 rounded-xl opacity-5 transform -rotate-3"></div>
              <img 
              ...
              <div className="absolute -bottom-10 -left-10 bg-white p-6 rounded-xl shadow-xl max-w-xs hidden md:block">
                <div className="flex items-center space-x-4 mb-3">
                  <div className="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center">
                    <IconWater className="text-amber-600" />
                  </div>
