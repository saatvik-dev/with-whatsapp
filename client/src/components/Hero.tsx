  ...
  return (
    <section className="min-h-screen flex items-center pt-16 relative overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="absolute inset-0 z-0 opacity-10">
        <div className="absolute h-56 w-56 rounded-full bg-green-300 top-20 left-10"></div>
        <div className="absolute h-64 w-64 rounded-full bg-green-400 bottom-20 right-10"></div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="w-full md:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#contact" className="px-8 py-3 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition-colors shadow-md text-center">
            ...
            <div className="flex flex-wrap items-center mt-12 gap-x-6 gap-y-4">
              <div className="flex items-center">
                <IconCheck className="text-green-600 mr-2" />
          ...
          <div className="w-full md:w-1/2">
            <div className="relative">
              <div className="absolute inset-0 -m-16 bg-green-500 rounded-full filter blur-3xl opacity-10"></div>
              <img 
              ...
              <div className="absolute -bottom-8 right-8 z-20 bg-white p-4 rounded-lg shadow-xl">
                <div className="flex items-center space-x-2">
                  <span className="text-green-600"><IconCheck size={20} /></span>
